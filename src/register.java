...
public class register extends JFrame {
	...
	public register() {
		...
		password.setBounds(305, 327, 150, 33);
		contentPane.add(password);
		
		confirm_password = new JPasswordField();
		confirm_password.setBounds(305, 370, 150, 33);
		...
		registerbtn.setBounds(210, 447, 219, 45);
